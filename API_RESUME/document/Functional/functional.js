module.exports = (values) => {
  ...
  <!DOCTYPE html>
            ...
            <!-- <img src="http://images2.fanpop.com/images/photos/4700000/Codeman-cody-lambert-4776780-500-375.jpg" alt="Cody Man"> -->
                <div class="name">${firstname} ${lastname}</div>
                    ...
                    <div class="objective">
                        ...
                        <div class="objective-text">${about}
                        </div>
                    </div >
                    <div class="phone">
                    ...
                    <div class="email">
                        ...
                        <span style="padding-right: 15px; font-size : 20px; font-style: normal;"><i class="far fa-envelope"></i></span>${email}
                        </div>
                        <div class= 'email-text' >
                        <span style="padding-right: 15px; font-size : 20px; font-style: normal;"><i class="fab fa-github"></i></span> ${github}
                        </div>
                            
                        <div class="email-text">
                        <span style="padding-right: 15px; font-size :20px; font-style: normal;"><i class="fab fa-linkedin"></i></span> ${linkedin}
                        </div>
                        <div class="email-text">
                        <span style="padding-right: 15px; font-size: 20px; font-style: normal;"><i class="fab fa-twitter-square"></i></span> ${twitter}
                        </div>
                    </div>
                </div>
            </div>
    ...
    if (skill2 != '' && skill2 != null)
        htmlTemplate += `<li class="l1">${skill2}</li>
                `;
    ...
    if (interest3 != '' && interest3 != null)
        htmlTemplate += `<li class="l1">${interest3}</li>
                `;
    if (interest4 != '' && interest4 != null)
        htmlTemplate += `<li class="l1">${interest4}</li>
                `;
    if (interest5 != '' && skill5 != null)
        htmlTemplate += `<li class="l1">${interest5}</li>
                `;
    if (interest6 != '' && skill6 != null)
        htmlTemplate += `<li class="l1">${interest6}</li>
        `;
    htmlTemplate += `
                </ul>
            </div>
