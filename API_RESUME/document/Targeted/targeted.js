  ...
  <!DOCTYPE html>
	...
	* {
    ...
    htmlTemplate += `
            ...
            <h3>${institute3}</h3>
            <p class="text-muted light mt-1 mb-2" style="font-size:17px;">${position3}<span class="ml-5 pl-5">Duration: ${duration3}</span></p>
            <p class="justified" style="font-size:17px;">${experienceDescription3}</p>
